...
<div class="header">
		   <div class="col-sm-8 header-left">
	            ...
	            <div class="col-sm-4 header_right">
	    		      <div id="loginContainer"><a href="index" id="loginButton"><img src="images/login.png"><span> Logout</span></a>
   		...
   		<h1>What are you looking for?</h1>
   	       <div class="dropdown-buttons">   
            		  <div class="dropdown-button">           			
						...
						<option value="all-rooms.jsp">All Rooms</option>
						<option value="#">Single Rooms</option>
						<option value="#">Dual Rooms</option>
						<option value="#">Luxury Rooms</option>
						<option value="#">Normal Rooms</option>
   ...
   <div class="living_middle">
   	  <div class="container">
   	  	<h2 class="title block-title">Available Rooms</h2>
