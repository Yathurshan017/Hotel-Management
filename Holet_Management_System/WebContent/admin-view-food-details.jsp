...
<body>
	...
	<div class="container" style="text-align:center; padding-top: 10px;">
		...
		<div class="row">
			<div class="col-sm-6">
				<form action="FoodController" method="get" class="form-horizontal" style="padding: 10px 0 10px 0;">
					<div class="input-group">
						...
						<div class="input-group-append">
							<c:url var="searchLink" value="FoodController">
			...
			<div class="col-sm-6" style="padding: 10px 15px 10px 15px;">
				<c:url var="checkLink" value="FoodController">
		...
		<div class="table-responsive" >
			<table class="table table-striped table-hover" style="width:100%;">
				...
				<tbody>
					...
					<c:forEach var="tempItem" items="${ FOOD_LIST }">
						<c:url var="updateLink" value="FoodController">
