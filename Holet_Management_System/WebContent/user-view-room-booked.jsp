...
<body>
	...
	<div class="container" style="text-align:center; padding-top: 10px;">
		...
		<div class="row">
			<div class="col-sm-6">
				<form action="RoomController" method="get" class="form-horizontal" style="padding: 10px 0 10px 0;">
					<div class="input-group">
						...
						<div class="input-group-append">
							<c:url var="searchLink" value="RoomController">
			...
			<div class="col-sm-6" style="padding: 10px 15px 10px 15px;">
				<c:url var="checkLink" value="RoomController">
			...
			<table class="table table-striped table-hover" style="width:150%;">
				...
				<tbody>
					...
					<c:forEach var="tempItem" items="${ ROOM_LIST }">
						<c:url var="updateLink" value="RoomController">
							<c:param name="COMMAND" value="LOAD"/>
							<c:param name="id" value="${tempItem.id}"/>
						</c:url>
						<c:url var="deleteLink" value="RoomController">
