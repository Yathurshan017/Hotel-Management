   		...
   		<h1>What are you looking for?</h1>
   	      <div class="dropdown-buttons"> 
            		  ...
            		  <div class="dropdown-button">           			
						...
						<option value="available-vehicles.jsp">Car</option>
						<option value="available-vehicles.jsp">Van</option>
						<option value="available-vehicles.jsp">Auto</option>
						<option value="available-vehicles.jsp">Bike</option>
...
<button type="button" class="btn btn-warning btn-lg" onclick="location.href = 'available-vehicles.jsp';">Check Available</button>
   ...
   <div class="living_middle">
   	  <div class="container">
   	  		<h2 class="title block-title">All Vehicles</h2>
		   ...
		   <div class="col-md-3 grid_box">
				...
				<h3><a href="#">Audi Q3</a></h3>
				<p>Feel The Premium loyalty Audi Q3 car</p>
                ...
                <tbody><tr>
                   ...
                   <td><img src="" alt="" style="margin-right:7px;">$20.00</td>
		   ...
		   <div class="col-md-3 grid_box">
				...
				<div class="living_desc">
				<h3><a href="#">Dolphin</a></h3>
				<p>Lorem ipsum consectetuer  </p>
				<a href="book-vehicles.jsp" class="btn3">Book</a>
				<p class="price">$20.00</p>
				</div>
			    <table border="1" class="propertyDetails">
		   ...
		   <div class="col-md-3 grid_box">
		   	   <div class="living_box"><a href="#">
			    <img src="images/honda1.png" class="img-responsive" alt=""/>
				<span class="sale-box">
				  <span class="sale-label">Bike</span>
			    </span>
				</a>
				<div class="living_desc">
				<h3><a href="#">Honda</a></h3>
				<p>Lorem ipsum consectetuer consectetuer </p>
				<a href="book-vehicles.jsp" class="btn3">Book</a>
                ...
                <tbody><tr>
                   <td><img src="images/area.png" alt="" style="margin-right:7px;">1 KM</td>
                   <td><img src="" alt="" style="margin-right:7px;">$5.00</td>
		 ...
		 <div class="col-md-3 grid_box">
				...
				<span class="sale-box">
				  <span class="sale-label">Auto</span>
			    </span>
				</a>
				<div class="living_desc">
				<h3><a href="#">Bajaj</a></h3>
				<p>Lorem ipsum consectetuer  consectetuer Auto</p>
				<a href="book-vehicles.jsp" class="btn3">Book</a>
